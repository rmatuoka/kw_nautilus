...
ActiveRecord::Schema.define(:version => 20130215134744) do
  ...
  create_table "categories", :force => true do |t|
    ...
    t.text     "description"
    t.string   "link"
    t.string   "selo_file_name"
    t.string   "selo_content_type"
    t.integer  "selo_file_size"
    t.datetime "selo_updated_at"
  end
